    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                className={`
                    flex items-center gap-2 rounded-full border bg-paper px-4 py-2 text-sm font-medium transition-all
                    ${isOpen
                ...
                disabled={isPending}
            >
                <span className="uppercase tracking-wide">{localeLabels[locale]}</span>
                <svg
                        ...
                        {supportedLocales.map((cur) => (
                            <li key={cur}>
                                ...
                                >
                                    ...
                                    {locale === cur && (
                                        <svg className="ml-3 h-4 w-4 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
