...
## Phase 1.5: アプリケーション機能実装と詳細化 (Web Application Implementation)
- [ ] **1. 多言語対応の実装 (i18n UI/UX)**
    - [ ] **[準備]** 検証用ダミーデータの用意
...
- [ ] **3. 一覧ページの実装 (Works / Composers Index)**
...
- [ ] **4. 検索機能の実装 (Pagefind Integration)**
